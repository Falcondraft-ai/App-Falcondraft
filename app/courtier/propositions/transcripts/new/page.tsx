...
export default async function NewCourtierTranscriptPage() {
    ...
    <PageTransition>
      <div className="mx-auto max-w-5xl space-y-6">
        <PageHeader
          ...
          description="Collez le contenu d'un échange commercial. Il pourra être lié à une proposition existante."
        />
