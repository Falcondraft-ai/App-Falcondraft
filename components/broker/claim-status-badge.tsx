import {
  ...
  brokerClaimStatusTone,
  isBrokerClaimStatus,
  type BrokerClaimStatus,
...
export function ClaimStatusBadge({
  ...
  const safe: BrokerClaimStatus = isBrokerClaimStatus(status)
    ? status
    : "declared";
  const tokens = familyTokens[brokerClaimStatusTone[safe]];
